...
namespace OpenBve {
	...
	#pragma warning restore 0219
		...
		private void ApplyLanguage()
		{
			...
			comboBoxCompatibilitySignalType.Items[3] = Translations.GetInterfaceString("options_other_signal_de2");
			//comboBox
			//Options Page
		...
		private void formMain_FormClosing(object sender, FormClosingEventArgs e)
		{
			...
			Interface.CurrentOptions.compatibilitySignalType = (Interface.CompatibilitySignalType) comboBoxCompatibilitySignalType.SelectedIndex;
