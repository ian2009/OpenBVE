		...
		private static void LoadCompatibilitySignalData(ref RouteData Data, System.Text.Encoding Encoding)
		{
			...
			switch (Data.compatibilitySignalType)
			{
				...
				case Interface.CompatibilitySignalType.BritishRail:
					...
					new ObjectManager.StaticObject[]
					{
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "BritishRail\\repeatingsignal_0.csv"),Encoding, false, false, false),
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "BritishRail\\repeatingsignal_1.csv"),Encoding, false, false, false),
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "BritishRail\\repeatingsignal_1.csv"),Encoding, false, false, false)
					});
					break;
				case Interface.CompatibilitySignalType.DeutscheBundesbahn:
					...
					Data.Signals[6] = new CompatibilitySignalData(new int[] {0, 3, 4}, new ObjectManager.StaticObject[]
					{
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DB\\repeatingsignal_0.csv"),Encoding, false, false, false),
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DB\\repeatingsignal_1.csv"),Encoding, false, false, false),
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DB\\repeatingsignal_2.csv"),Encoding, false, false, false)
					});
					Data.CompatibilitySignals[0] = new CompatibilitySignalData(new int[] {0, 2},
					new ObjectManager.StaticObject[]
					{
					...
					break;
				case Interface.CompatibilitySignalType.DeutscheBundesbahnNew:
					/*
					 * Total signal change
					 */
					CompatibilityObjects.SignalPost = ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DB\\signal_post.b3d"), System.Text.Encoding.UTF8, false, false, false);
					Data.Signals[3] = new CompatibilitySignalData(new int[] {0, 2, 4}, new ObjectManager.StaticObject[]
					{
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DBNew\\signal_0.csv"), System.Text.Encoding.UTF8, false, false, false),
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DBNew\\signal_1.csv"), System.Text.Encoding.UTF8, false, false, false),
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DBNew\\signal_2.csv"), System.Text.Encoding.UTF8, false, false, false)
					});
					Data.Signals[4] = new CompatibilitySignalData(new int[] {0, 1, 2, 4}, new ObjectManager.StaticObject[]
					{
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DBNew\\signal_3.csv"), System.Text.Encoding.UTF8, false, false, false),
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DBNew\\signal_4.csv"), System.Text.Encoding.UTF8, false, false, false),
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DBNew\\signal_4.csv"), System.Text.Encoding.UTF8, false, false, false),
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DBNew\\signal_5.csv"), System.Text.Encoding.UTF8, false, false, false)
					});
					Data.Signals[5] = new CompatibilitySignalData(new int[] {0, 1, 2, 3, 4}, new ObjectManager.StaticObject[]
					{
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DBNew\\signal_3.csv"), System.Text.Encoding.UTF8, false, false, false),
						...
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DBNew\\signal_4.csv"), System.Text.Encoding.UTF8, false, false, false),
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DBNew\\signal_5.csv"), System.Text.Encoding.UTF8, false, false, false),
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DBNew\\signal_6.csv"), System.Text.Encoding.UTF8, false, false, false)
					});
					Data.Signals[6] = new CompatibilitySignalData(new int[] {0, 3, 4}, new ObjectManager.StaticObject[]
					{
						ObjectManager.LoadStaticObject(OpenBveApi.Path.CombineFile(SignalFolder, "DB\\repeatingsignal_0.csv"),Encoding, false, false, false),
