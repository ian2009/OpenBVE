								...
								else if (Data.Blocks[i].Forms[k].SecondaryRail > 0)
								{
									...
									else
									{
										...
										if (d0 < 0.0)
										{
											...
											{
												StaticObject FormC = (StaticObject)Data.Structure.FormCL[Data.Blocks[i].Forms[k].FormType].CreateTransformedObject(d0, d1);
											...
											if (Data.Blocks[i].Forms[k].RoofType > 0)
											{
												...
												{
													StaticObject RoofC = (StaticObject)Data.Structure.RoofCL[Data.Blocks[i].Forms[k].RoofType].CreateTransformedObject(d0, d1);
										...
										else if (d0 > 0.0)
										{
											...
											{
												StaticObject FormC = (StaticObject)Data.Structure.FormCR[Data.Blocks[i].Forms[k].FormType].CreateTransformedObject(d0, d1);
												Program.Renderer.CreateStaticObject(FormC, pos, RailTransformation, NullTransformation, Data.AccurateObjectDisposal, StartingDistance, EndingDistance, Data.BlockInterval, StartingDistance);
											}
											if (Data.Blocks[i].Forms[k].RoofType > 0)
											{
												...
												{
													StaticObject RoofC = (StaticObject)Data.Structure.RoofCR[Data.Blocks[i].Forms[k].RoofType].CreateTransformedObject(d0, d1);
													Program.Renderer.CreateStaticObject(RoofC, pos, RailTransformation, NullTransformation, Data.AccurateObjectDisposal, StartingDistance, EndingDistance, Data.BlockInterval, StartingDistance);
												}
											}
										}
							...
							if (Data.Blocks[i].Cracks[k].PrimaryRail == j)
							{
								...
								else
								{
									...
									if (d0 < 0.0)
									{
										...
										{
											StaticObject Crack = (StaticObject)Data.Structure.CrackL[Data.Blocks[i].Cracks[k].Type].CreateTransformedObject(d0, d1);
									...
									else if (d0 > 0.0)
									{
										...
										{
											StaticObject Crack = (StaticObject)Data.Structure.CrackR[Data.Blocks[i].Cracks[k].Type].CreateTransformedObject(d0, d1);
											Program.Renderer.CreateStaticObject(Crack, pos, RailTransformation, NullTransformation, Data.AccurateObjectDisposal, StartingDistance, EndingDistance, Data.BlockInterval, StartingDistance);
										}
									}
								}
