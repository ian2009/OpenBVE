...
namespace OpenBveApi.Objects
{
	...
	public class StaticObject : UnifiedObject
	{
		...
		/// <summary>Creates a transformed copy of the this object (e.g. Platform top, roof etc.)</summary>
		...
		public override UnifiedObject CreateTransformedObject(double NearDistance, double FarDistance)
		{
			StaticObject Result = (StaticObject)this.Clone();
			int n = 0;
