...
namespace Plugin
{
	...
	internal class CompatibilityObjects
	{
		...
		internal static void LoadAutoGeneratedObjects(string CompatibilityFolder, out string LimitGraphicsPath)
		{
			...
			Plugin.currentHost.LoadObject(OpenBveApi.Path.CombineFile(SignalPath, "signal_post.csv"), System.Text.Encoding.UTF8, out SignalPost);
